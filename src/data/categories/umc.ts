...
export const umcData: CategoryData = {
  ...
  items: [
    ...
    },
    {
      id: 104,
      type: 'instagram',
      title: 'Small Movements, Big Smiles! 🤗',
      category: 'United Medicare Centre',
      subCategory: '',
      publication: 'UMC',
      highlight: 'Fine motor activities boost strength, coordination, and brighten seniors’ daily routines! 🌟',
      link: 'https://www.instagram.com/p/C3CsmnmIknh/?img_index=1',
      date: '2024',
      image: '/images/umc/umc 2.png',
      caption: 'Fine motor activities boost strength, coordination, and brighten seniors’ daily routines! 🌟',
    },
    {
      id: 105,
      type: 'instagram',
